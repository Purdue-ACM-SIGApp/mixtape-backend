...
async fn share(db: &Database, user:ID, phone:&impl Phone, numbers: Vec<String>) -> impl Responder {
    ...
    let message = "🎶 Introducing Mixtape: The Ultimate Playlist Collaboration App! 🎶\n
        ...
        I've just stumbled upon something incredible that's about to revolutionize the way we share and discover music.\n
        It's called Mixtape, and it's a game-changer for music enthusiasts like us:\n
        ...
        Let's create musical magic together! 🎉🎵✨ #MixtapeApp";
